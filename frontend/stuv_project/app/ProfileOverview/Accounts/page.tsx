  ...
  <div>
    ...
    <div>
        ...
        <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
            ...
            <ul>
            <li className="mt-5 cursor-pointer border-l-2 border-l-blue-700 px-2 py-2 font-semibold text-blue-700 transition hover:border-l-blue-700 hover:text-blue-700"><a href='/ProfileOverview/Accounts/'>Accounts</a></li>
            ...
            <div className="col-span-8 overflow-hidden rounded-xl bg-gray-50 px-8 shadow">
                <div className="border-b pt-4 pb-8">
                    ...
                    <p className="font- text-slate-600">All settings and informations regarding your account.</p>
                </div>
                <div className="mt-4">
                    <h2 className="text-lg font-semibold leading-4 text-slate-700">Registration Date</h2>
                    <p className="font- text-slate-600">05.04.1998</p>
                </div>
                <div className="grid border-b py-3"></div>
                <div className="mt-4">
                    <h2 className="text-lg font-semibold leading-4 text-slate-700">Death Date</h2>
                    <p className="font- text-slate-600">05.04.2026</p>
                </div>
            </div>
        </div>
        </div>
