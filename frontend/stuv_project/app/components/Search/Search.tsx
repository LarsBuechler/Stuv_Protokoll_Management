    ...
    <div className="flex items-center justify-center pt-40 pb-20">
        <form className='w-full max-w-[70%]'>   
            ...
            <div className="relative">
                ...
                <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-neutral border border-gray-300 rounded-lg bg-gray-50 focus:ring-gray-500 focus:border-gray-500 dark:bg-stone-50 dark:border-gray-600 dark:placeholder-neutral dark:text-neutral dark:focus:ring-gray-500 dark:focus:border-gray-500" placeholder="Suche nach Stichwörtern" required></input>
