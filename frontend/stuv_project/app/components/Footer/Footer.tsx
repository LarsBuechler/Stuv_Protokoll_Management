...
const Footer = () => {
  return (
    <footer className="footer footer-center p-6 bg-base-200 text-base-content position:sticky rounded bottom-0 left-0">
        ...
        <aside>
            <p>Copyright © 2024 - All right reserved by NotStupidIdeas GmbH & Co. KG</p>
        </aside>
    </footer>
  )
}
