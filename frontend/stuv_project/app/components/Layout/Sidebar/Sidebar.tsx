    ...
    <div className="relative flex flex-col bg-clip-border rounded-xl bg-base-100 text-base-content max-h-[100%] w-full max-w-[20rem] p-4 shadow-xl shadow-base-300">
        <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-base-content">
            ...
            <div className="mb-2 pt-2">
                <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-base-content">Overviews</h5>
            </div>

            <Link href ='/'>
            <div role="button" className="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-base-200 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-base-300 active:bg-opacity-80 hover:text-base-content focus:text-blue-900 active:text-info-content outline-none">
            ...
            <div>
                <details className="relative w-full">
                    <summary role="button" className="flex items-center pl-4 p-3 rounded-lg text-start leading-tight transition-all hover:bg-base-200 hover:bg-opacity-80 focus:bg-base-200 focus:bg-opacity-80 active:bg-base-300 active:bg-opacity-80 hover:text-base-content focus:text-primary-content active:text-info-content outline-none">
                        <div className='ml-4'>
                            AI Overview
                        </div>
                    </summary>
                    <div className="ml-12">
                        <button className="block p-2 text-sm hover:text-info-content"><a href='https://mlflow.org' target='blank'>MLFlow</a></button>
                        <button className="block p-2 text-sm hover:text-info-content"><a href='https://www.bentoml.com' target='blank'>BentoML</a></button>
                        <button className="block p-2 text-sm hover:text-info-content"><a href='http://zenml.io' target='blank'>ZenML</a></button>
                    </div>
                </details>
            </div>

            <Link href='/UploadOverview'>
            <div role="button" className="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-base-200 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-base-300 active:bg-opacity-80 hover:text-base-content focus:text-blue-900 active:text-info-content outline-none">
                <div className="grid place-items-center mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5">
                    <path fillRule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 4.889c-.02.12-.115.26-.297.348a7.493 7.493 0 00-.986.57c-.166.115-.334.126-.45.083L6.3 5.508a1.875 1.875 0 00-2.282.819l-.922 1.597a1.875 1.875 0 00.432 2.385l.84.692c.095.078.17.229.154.43a7.598 7.598 0 000 1.139c.015.2-.059.352-.153.43l-.841.692a1.875 1.875 0 00-.432 2.385l.922 1.597a1.875 1.875 0 002.282.818l1.019-.382c.115-.043.283-.031.45.082.312.214.641.405.985.57.182.088.277.228.297.35l.178 1.071c.151.904.933 1.567 1.85 1.567h1.844c.916 0 1.699-.663 1.85-1.567l.178-1.072c.02-.12.114-.26.297-.349.344-.165.673-.356.985-.57.167-.114.335-.125.45-.082l1.02.382a1.875 1.875 0 002.28-.819l.923-1.597a1.875 1.875 0 00-.432-2.385l-.84-.692c-.095-.078-.17-.229-.154-.43a7.614 7.614 0 000-1.139c-.016-.2.059-.352.153-.43l.84-.692c.708-.582.891-1.59.433-2.385l-.922-1.597a1.875 1.875 0 00-2.282-.818l-1.02.382c-.114.043-.282.031-.449-.083a7.49 7.49 0 00-.985-.57c-.183-.087-.277-.227-.297-.348l-.179-1.072a1.875 1.875 0 00-1.85-1.567h-1.843zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" clipRule="evenodd"></path>
            ...
            <Link href='https://readthedocs.org/dashboard/' target='blank'>
            <div role="button" className="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-base-200 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-base-300 active:bg-opacity-80 hover:text-base-content focus:text-blue-900 active:text-info-content outline-none">
                <div className="grid place-items-center mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5">
                    <path fillRule="evenodd" d="M11.078 2.25c-.917 0-1.699.663-1.85 1.567L9.05 4.889c-.02.12-.115.26-.297.348a7.493 7.493 0 00-.986.57c-.166.115-.334.126-.45.083L6.3 5.508a1.875 1.875 0 00-2.282.819l-.922 1.597a1.875 1.875 0 00.432 2.385l.84.692c.095.078.17.229.154.43a7.598 7.598 0 000 1.139c.015.2-.059.352-.153.43l-.841.692a1.875 1.875 0 00-.432 2.385l.922 1.597a1.875 1.875 0 002.282.818l1.019-.382c.115-.043.283-.031.45.082.312.214.641.405.985.57.182.088.277.228.297.35l.178 1.071c.151.904.933 1.567 1.85 1.567h1.844c.916 0 1.699-.663 1.85-1.567l.178-1.072c.02-.12.114-.26.297-.349.344-.165.673-.356.985-.57.167-.114.335-.125.45-.082l1.02.382a1.875 1.875 0 002.28-.819l.923-1.597a1.875 1.875 0 00-.432-2.385l-.84-.692c-.095-.078-.17-.229-.154-.43a7.614 7.614 0 000-1.139c-.016-.2.059-.352.153-.43l.84-.692c.708-.582.891-1.59.433-2.385l-.922-1.597a1.875 1.875 0 00-2.282-.818l-1.02.382c-.114.043-.282.031-.449-.083a7.49 7.49 0 00-.985-.57c-.183-.087-.277-.227-.297-.348l-.179-1.072a1.875 1.875 0 00-1.85-1.567h-1.843zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" clipRule="evenodd"></path>
