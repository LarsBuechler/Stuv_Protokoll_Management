    ...
    <div className='grid grid-cols-8 gap-4 pt-4'>
        ...
        <div className='col-start-3 col-end-6'>
            <div className='hover:scale-105 pl-40'>
                <div className="relative flex items-center w-full h-10 rounded-lg focus-within:shadow-lg bg-base-100 hover:bg-base-200 overflow-hidden shadow shadow-blue-gray-900/5">
        ...
        <div className='col-start-6 col-end-10'>
            <div className='grid grid-cols-5 gap-4'>
                ...
                <div className='col-start-3 col-end-4 ml-12'>
                    <ul className="menu menu-horizontal dropdown-content">
                        <li>
                            <details>
                            <summary className='text-sm font-semibold bg-base-100 hover:scale-105 hover:bg-base-200 text-base-content'>Theme</summary>
                            <ul className='bg-base-100 text-base-content'>
                                <li className='text-sm font-medium'><button className='hover:bg-white hover:text-black'>Light</button></li>
                                <li className='text-sm font-medium'><button className='hover:bg-black hover:text-white'>Dark</button></li>
                                <li className='text-sm font-medium'><button className=''><div></div></button></li>
                            </ul>
                            </details>
                        </li>
                    </ul>
                ...
                <div className='col-start-5 col-end-5'>
                    ...
                    {isDropdownOpen && (
                        <div id="dropdownAvatar" className="absolute rounded-lg shadow w-44 bg-base-100 text-base-content right-0 mr-8 mt-2 shadow-blue-gray-900/5">
