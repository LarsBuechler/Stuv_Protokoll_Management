  ...
  return (
    <div className='grid grid-cols-8 gap-4 pt-4'>
        ...
        <div className='col-span-2'>
            <Link href='/' className="btn btn-ghost hover:bg-base-200 active:bg-neutral active:text-base-100 transform hover:scale-105 text-3xl font-bold">
        ...
        <div className='col-start-6 col-end-10'>
            <div className='grid grid-cols-5 gap-4'>
                    ...
                    <ul className="menu menu-horizontal dropdown-content">
                        <li>
                            ...
                            <ul>
                                ...
                                <li className='text-sm font-medium'><button className='hover:bg-secondary hover:text-primary-content'>Mixed</button></li>
                            </ul>
                            </details>
                        </li>
                    </ul>
                ...
                <div className='col-start-5 col-end-5'>
                    ...
                    {isDropdownOpen && (
                        <div id="dropdownAvatar" className="absolute rounded-lg shadow w-44 bg-base-100">
                            ...
                            <div className='px-4 py-2 text-sm font-normal'>
                                <ul>
                                    <li className=''>
                                        <Link href="/Profile" className="block font-medium hover:text-primary">Profile</Link>
                                    </li>
                                </ul>
                            </div>
                            <div className="pb-2">
                                <a href="" className="block px-4 py-2 text-sm font-medium hover:text-primary">Log out</a>
                            </div>
                        </div>
                    )}
                </div>
