...
const Output = () => {
  return (
<div className='rounded-lg shadow shadow-base-300 mr-4'>
    <ul className="timeline timeline-snap-icon mx-20 pb-20 pt-5 max-md:timeline-compact timeline-vertical text-base-content">
        <li>
