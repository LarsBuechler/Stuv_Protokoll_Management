...
const Sidebar = () => {
  return (
    <div className="fixed flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 max-h-[100%] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
        <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700">
            
            <div className="mb-2 pt-2">
                <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900">Overviews</h5>
            </div>
            ...
            <a href ='/DocumentOverview'>Document Overview</a>
            </div>

            <div>
                <details className="relative w-full">
                <summary role="button" className="flex items-center pl-4 p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-blue-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
                    <div className='ml-4'>
                        AI Overview
                    </div>
                </summary>
                <div className="ml-12">
                    <button className="block p-2 text-sm hover:text-blue-900"><a href='https://mlflow.org' target='blank'>MLFlow</a></button>
                    <button className="block p-2 text-sm hover:text-blue-900"><a href='https://www.bentoml.com' target='blank'>BentoML</a></button>
                    <button className="block p-2 text-sm hover:text-blue-900"><a href='http://zenml.io' target='blank'>ZenML</a></button>
                </div>
                </details>
            </div>
            ...
            <a href='/UploadOverview'>Upload Overview</a>
            </div>
            ...
            <a href='https://readthedocs.org/dashboard/' target='blank'>Read the Docs</a>
            </div>


            <div className="border-b pt-1"></div>
            <div className="mb-2 pt-2">
                <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900">Settings</h5>
            </div>
